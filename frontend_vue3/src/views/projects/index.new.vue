<template>
  <div class="projects-container">
    ...
    >
      <el-form ref="crud.formRef" :model="crud.formData" :rules="formRules" label-width="180px">
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="crud.submitLoading.value" @click="crud.handleSubmit(formRules)">Confirm</el-button>
      </template>
    </el-dialog>
  </div>
</template>
...
function handleExportSelected(format: string) {
  if (format === 'image') {
    exportHelper.handleBatchExportImages(
      ...
      'ProjectID',
      (id: number) => `/api/v1/projects/${id}/export_image`,
      'ProjectName'
    )
  } else {
