  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: 'Projects', icon: 'Operation', affix: true },
      },
      {
        path: 'projects/:id',
        name: 'ProjectDetail',
      ...
      },
      {
        ...
        meta: { title: 'Materials', icon: 'Box' },
      },
      {
        path: 'fillers',
        name: 'Fillers',
        component: () => import('@/views/fillers/index.vue'),
        meta: { title: 'Fillers', icon: 'Box' },
      },
      {
        path: 'formulas',
        name: 'Formulas',
        component: () => import('@/views/formulas/index.vue'),
        meta: { title: 'Formulas', icon: 'List' },
      },
      {
        path: 'test-results',
        name: 'TestResults',
        component: () => import('@/views/test-results/index.vue'),
        meta: { title: 'Test Results', icon: 'DataAnalysis' },
      },
      {
        path: 'profile',
        name: 'Profile',
