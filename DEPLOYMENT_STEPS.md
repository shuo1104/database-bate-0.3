...
- 所有部署动作遵守 **“更换生成服务器环境后能快速移植部署”** 原则，优先采用可复用脚本与可配置路径。
...
**需要修改的文件**：
1. `backend_fastapi/deploy/photopolymer-api.service` - 6处路径
2. `frontend_vue3/deploy/photopolymer-frontend.conf` - 2处路径
