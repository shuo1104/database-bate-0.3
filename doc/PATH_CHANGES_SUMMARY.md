...
### 1. 后端 Systemd 服务配置
**文件**: `backend_fastapi/deploy/photopolymer-api.service`
...
### 2. 前端 Nginx 配置
**文件**: `frontend_vue3/deploy/photopolymer-frontend.conf`
...
# 2. 更新后端配置
sudo cp backend_fastapi/deploy/photopolymer-api.service /etc/systemd/system/
