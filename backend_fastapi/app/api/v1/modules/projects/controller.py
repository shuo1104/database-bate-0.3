...
async def get_project_list(
    ...
    projects, total = await ProjectService.get_project_list(
        db=db, page=page, page_size=page_size, query_params=query_params
    )
...
async def export_projects(
    ...
    **性能优化**:
    ...
    # 构建查询参数
    query_params = ProjectQueryParams(
        project_type=project_type, formulator=formulator, keyword=keyword
    )
...
async def export_project_image(
    ...
    if not project:
        return Response(
            content=b"Project not found", status_code=404, media_type="text/plain"
        )
    ...
    try:
        ...
        logger.error("Failed to generate project image report: %s", e, exc_info=True)
        return Response(
            content=b"Failed to generate project image report",
            status_code=500,
            media_type="text/plain; charset=utf-8",
        )
...
async def get_project_detail(
    ...
    return SuccessResponse(data=project.model_dump(mode="json"), msg="查询成功")
...
async def create_project(
    ...
    return SuccessResponse(data=project.model_dump(mode="json"), msg="项目创建成功")
...
async def update_project(
    ...
    return SuccessResponse(data=project.model_dump(mode="json"), msg="项目更新成功")
...
async def delete_project(
    ...
    return SuccessResponse(data=None, msg="项目删除成功")
...
async def batch_delete_projects(
    ...
    return SuccessResponse(
        data={"deleted_count": count}, msg=f"成功删除 {count} 个项目"
    )
...
async def get_project_types(
    ...
    return SuccessResponse(
        data=[t.model_dump(mode="json") for t in types], msg="查询成功"
    )
...
async def get_formulators(
    ...
    return SuccessResponse(data=formulators, msg="查询成功")
...
async def get_project_compositions(
    ...
    return SuccessResponse(
        data=[c.model_dump(mode="json") for c in compositions], msg="查询成功"
    )
...
async def create_composition(
    ...
    return SuccessResponse(
        data=composition.model_dump(mode="json"), msg="配方成分添加成功"
    )
...
async def update_composition(
    ...
    return SuccessResponse(
        data=composition.model_dump(mode="json"), msg="配方成分更新成功"
    )
...
async def delete_composition(
    ...
    return SuccessResponse(data=None, msg="配方成分删除成功")
