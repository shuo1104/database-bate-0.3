...
async def login(
    ...
    return SuccessResponse(data=result.model_dump(mode="json"), msg="登录成功")


@router.post(
    "/register", response_model=None, summary="用户注册", description="用户注册接口"
)
async def register(
    ...
    return SuccessResponse(data=result.model_dump(mode="json"), msg="注册成功")
...
async def get_current_user_info(
    ...
    return SuccessResponse(data=result.model_dump(mode="json"), msg="获取成功")
...
async def update_profile(
    ...
    return SuccessResponse(data=result.model_dump(mode="json"), msg="更新成功")
...
async def change_password(
    ...
    return SuccessResponse(data=None, msg="密码修改成功，请重新登录")
...
async def create_user(
    ...
    return SuccessResponse(data=result.model_dump(mode="json"), msg="创建成功")
...
async def reset_user_password(
    ...
    return SuccessResponse(data=None, msg="密码重置成功")
